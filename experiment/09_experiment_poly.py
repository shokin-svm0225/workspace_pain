            ...
            for degree in degree_values:
                for coef0 in coef0_values:
                    ...
                    for train_index, val_index in skf.split(datas, labels):
                        ...
                        svm = SVC(C=C, kernel='poly',gamma=gamma,degree=degree,coef0=coef0, max_iter=1500)
                    ...
                    st.write(f"C: {C}, gamma: {gamma}, degree: {degree}, coef0: {coef0}, Score: {avg_score:.4f}")

                    if avg_score > best_score:
                        best_score = avg_score
                        best_params = {"C": C, "gamma": gamma, "degree": degree, "coef0": coef0}
                        best_model = svm
