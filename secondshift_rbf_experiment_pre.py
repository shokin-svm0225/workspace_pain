...
def main():
    ...
    # ※ 重要：run_hill_climbing の呼び出しシグネチャは変更しません
    #   run_hill_climbing(step_size, gamma, C, datas, labels)
    ...
    # gamma / coef0 / degree は UI で持っているが、ここでは RBF/sigmoid/poly/linear の代表値に留める
    # ※ 厳密にやる場合は best_result に kernel/coef0/degree を含めるよう内部実装側を拡張してください。
